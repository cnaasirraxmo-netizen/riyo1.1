...
func GetEmbedProviders() []EmbedProvider {
	return []EmbedProvider{
		...
		{Name: "FlixHQ", URLPattern: "https://flixhq.to/embed/movie/%d"},
		{Name: "PrimeWire", URLPattern: "https://primewire.mx/embed/movie/%d"},
		{Name: "HdHub4u", URLPattern: "https://hdhub4u.work/embed/movie/%d"},
...
func GetTVEmbedProviders() []EmbedProvider {
	return []EmbedProvider{
		...
		{Name: "FlixHQ", URLPattern: "https://flixhq.to/embed/tv/%d/%d/%d"},
		{Name: "PrimeWire", URLPattern: "https://primewire.mx/embed/tv/%d/%d/%d"},
		{Name: "HdHub4u", URLPattern: "https://hdhub4u.work/embed/tv/%d/%d/%d"},
